<template>
  ...
  >
    <div
      class="mx-auto flex h-full items-center justify-between px-6 lg:container sm:px-8 md:px-12"
    >
      <div class="flex">
        <NuxtLink to="/">
              ...
              >
                ...
                >
                  ...
                  <BaseDropDown v-else anchor-style="px-4 py-1.5">
                    ...
                    <ul
                      class="absolute left-[calc(100%)] top-0 list-none rounded bg-white-default px-0 py-2 shadow-1"
                    >
                      <li class="transition duration-300 hover:bg-primary-soft">
                        <NuxtLink
                          class="navbarLink flex whitespace-nowrap px-4 py-1.5 text-body2 text-text-primary no-underline"
                          to="/mikrotik-vps/"
                        >
